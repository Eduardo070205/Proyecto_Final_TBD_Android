...
public class ActivityMenu extends Activity {
    ...
    public void abrirActivity(View v) {
        ...
        }else if (v.getId() == R.id.btnVehiculosConsultar){

            i = new Intent(this, ActivityConsultasVehiculos.class);

        }else if (v.getId() == R.id.btnModelosAgregar){

            i = new Intent(this, ActivityAltasModelos.class);

        }else if (v.getId() == R.id.btnModelosEliminar){

            i = new Intent(this, ActivityEliminarModelos.class);

        }else if (v.getId() == R.id.btnModelosModificar){
        ...
        }else if (v.getId() == R.id.btnMenuListaVehiculos){
